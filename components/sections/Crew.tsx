        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mb-12">
          <FadeIn delay={0.1}>
            <div className="border-2 border-black p-8">
              ...
              <Link href="/team">
                <button className="font-bebas uppercase tracking-wide px-6 py-3 text-base border-2 border-black text-black hover:bg-black hover:text-white transition-all">
                  Meet The Crew
                </button>
              </Link>
            </div>
          ...
          <FadeIn delay={0.2}>
            <div className="border-2 border-black p-8 bg-black text-white">
              ...
              <Typography variant="body" className="text-grey-400 mb-6">
              ...
              <Link href="/careers">
                <button className="font-bebas uppercase tracking-wide px-6 py-3 text-base border-2 border-white text-white hover:bg-white hover:text-black transition-all">
                  View Open Positions
                </button>
              </Link>
            </div>
